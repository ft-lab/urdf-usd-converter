...
class TestCli(ConverterTestCase):
    ...
    def test_conversion_exception_ros2_package_name_format(self):
        robot = "tests/data/simple_ref_ros2_package.urdf"
        output_dir = self.tmpDir()

        # Run the converter with the specified ROS2 package names.
    ...
    def test_conversion_exception_multiple_ros2_packages_name_format(self):
        robot = "tests/data/simple_ref_ros2_package.urdf"
        output_dir = self.tmpDir()
