...
def run() -> int:
    ...
    try:
        converter = Converter(
            layer_structure=not args.no_layer_structure, scene=not args.no_physics_scene, comment=args.comment, ros2_packages=args.package
        )
...
def __create_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action="append",
        default=[],
        help="ROS2 package name and file path (e.g. --package my_robot=/home/foo/my_robot)",
    )
